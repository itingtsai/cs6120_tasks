...
24:                                               ; preds = %12
  ...
  %26 = icmp eq i64 %25, %6
  br i1 %26, label %.loopexit, label %7, !llvm.loop !15
...
10:                                               ; preds = %.loopexit, %14
  %11 = phi double [ %32, %14 ], [ %.ph, %.loopexit ]
  %12 = add nuw nsw i64 %16, 1
  %13 = icmp eq i64 %33, %9
  br i1 %13, label %.loopexit1, label %14, !llvm.loop !16
...
14:                                               ; preds = %10, %5
  ...
  br i1 %34, label %.preheader, label %10

.preheader:                                       ; preds = %14
  br label %35

35:                                               ; preds = %.preheader, %49
  %36 = phi i64 [ %62, %49 ], [ %16, %.preheader ]
  %37 = phi double [ %61, %49 ], [ %32, %.preheader ]
...
49:                                               ; preds = %39
  ...
  %64 = icmp eq i32 %1, %63
  br i1 %64, label %.loopexit, label %35, !llvm.loop !18

.loopexit1:                                       ; preds = %10
  %.ph2 = phi double [ %11, %10 ]
  br label %65

65:                                               ; preds = %.loopexit1, %2
  %66 = phi double [ 0.000000e+00, %2 ], [ %.ph2, %.loopexit1 ]
...
26:                                               ; preds = %14
  ...
  %28 = icmp eq i64 %27, 5
  br i1 %28, label %.preheader1, label %9, !llvm.loop !15

.preheader1:                                      ; preds = %26
  %.ph2 = phi i32 [ 0, %26 ]
  %.ph3 = phi double [ 0.000000e+00, %26 ]
  br label %29

29:                                               ; preds = %.preheader1, %87
  %30 = phi i32 [ %89, %87 ], [ %.ph2, %.preheader1 ]
  %31 = phi double [ %88, %87 ], [ %.ph3, %.preheader1 ]
...
32:                                               ; preds = %.loopexit, %36
  %33 = phi double [ %54, %36 ], [ %.ph, %.loopexit ]
...
36:                                               ; preds = %32, %29
  ...
  br i1 %56, label %.preheader, label %32

.preheader:                                       ; preds = %36
  br label %57

57:                                               ; preds = %.preheader, %71
  %58 = phi i64 [ %84, %71 ], [ %38, %.preheader ]
  %59 = phi double [ %83, %71 ], [ %54, %.preheader ]
...
71:                                               ; preds = %61
  ...
  %86 = icmp eq i64 %85, 5
  br i1 %86, label %.loopexit, label %57, !llvm.loop !18
...
define range(i32 0, 2) i32 @verify_benchmark(i32 noundef %0) local_unnamed_addr #8 {
  %2 = icmp eq i32 %0, 0
  br i1 %2, label %40, label %.preheader
...
3:                                                ; preds = %32
  ...
  %5 = icmp eq i64 %4, 5
  br i1 %5, label %.loopexit1, label %6, !llvm.loop !21

6:                                                ; preds = %.preheader, %3
  %7 = phi i64 [ %4, %3 ], [ 0, %.preheader ]
...
32:                                               ; preds = %12
  ...
  br i1 %39, label %3, label %.loopexit1

.loopexit:                                        ; preds = %15, %24
  %.ph = phi i32 [ 0, %24 ], [ 0, %15 ]
  br label %40

.loopexit1:                                       ; preds = %3, %32
  %.ph2 = phi i32 [ 1, %3 ], [ 0, %32 ]
  br label %40

40:                                               ; preds = %.loopexit1, %.loopexit, %1
  %41 = phi i32 [ 0, %1 ], [ %.ph, %.loopexit ], [ %.ph2, %.loopexit1 ]
  ret i32 %41
}
